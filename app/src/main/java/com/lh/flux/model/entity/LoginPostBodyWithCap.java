...
public class LoginPostBodyWithCap {// "{\"SDK\":" + u.getSdk() + ",\"captcha\":\"" + cap + "\",\"channel\":\"default\",\"data\":{},\"imei\":\"" + u.getImei() + "\",\"imsi\":\"" + u.getImsi() + "\",\"isIOS\":\"false\",\"isPreInstalled\":false,\"manufacturer\":\"" + u.getManufacturer() + "\",\"mode\":\"" + u.getMode() + "\",\"userPhone\":\"" + u.getPhone() + "\"}";
    private int SDK;
